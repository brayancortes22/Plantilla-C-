    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActoresVoz", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Animes_Estudios_IdEstudio",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdActorVoz = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonajeVoces", x => new { x.IdPersonaje, x.IdActorVoz });
                    table.ForeignKey(
                        name: "FK_PersonajeVoces_ActoresVoz_IdActorVoz",
                        column: x => x.IdActorVoz,
                        principalTable: "ActoresVoz",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PersonajeVoces_Personajes_IdPersonaje",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnimeGeneros", x => new { x.IdAnime, x.IdGenero });
                    table.ForeignKey(
                        name: "FK_AnimeGeneros_Animes_IdAnime",
                        column: x => x.IdAnime,
                        principalTable: "Animes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnimeGeneros_Generos_IdGenero",
                        column: x => x.IdGenero,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnimePersonajes", x => new { x.IdAnime, x.IdPersonaje });
                    table.ForeignKey(
                        name: "FK_AnimePersonajes_Animes_IdAnime",
                        column: x => x.IdAnime,
                        principalTable: "Animes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnimePersonajes_Personajes_IdPersonaje",
                        column: x => x.IdPersonaje,
                        principalTable: "Personajes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstadoVisualizacion = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Id = table.Column<int>(type: "int", nullable: false),
                    Description = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsuarioAnimes", x => new { x.IdUser, x.IdAnime });
                    table.ForeignKey(
                        name: "FK_UsuarioAnimes_Animes_IdAnime",
                        column: x => x.IdAnime,
                        principalTable: "Animes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsuarioAnimes_Users_IdUser",
                        column: x => x.IdUser,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnimeGeneros_IdGenero",
                table: "AnimeGeneros",
                column: "IdGenero");

            migrationBuilder.CreateIndex(
                name: "IX_AnimePersonajes_IdPersonaje",
                table: "AnimePersonajes",
                column: "IdPersonaje");

            migrationBuilder.CreateIndex(
                name: "IX_Animes_IdEstudio",
                table: "Animes",
                column: "IdEstudio");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonajeVoces_IdActorVoz",
                table: "PersonajeVoces",
                column: "IdActorVoz");
